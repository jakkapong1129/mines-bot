...
class MinesBot:
    def __init__(self, bet_amount=0.1, use_martingale=False, required_wins=4, martingale_multiplier=4, max_martingale=10, max_shots=5, retry_count=3, selection_mode="row", single_shot_mode="win-stay", use_win_step=False, win_step_array=None, win_step_multiplier=2.0, win_step_wins=3):
        ...
        try:
            ...
            console.print("[bold red]❌ Error: token.txt file not found![/bold red]")
            sys.exit(1)
        except Exception as e:
            console.print(f"[bold red]❌ Error reading token.txt: {str(e)}[/bold red]")
            sys.exit(1)
